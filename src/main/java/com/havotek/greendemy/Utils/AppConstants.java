...
public interface AppConstants {
    ...
    String BASE_URL = "https://greendemy.greenleafstudios.com.ng";//change to your own domain where backend files have been hosted
    String API_CONTROLLER = "ApiController.php";
    String COUNTRY_PHONE_CODE = "+91"; //country code for phone verification

    String DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
    String APP_NAME = "GreenDemy";//change to your own app name
    ...
    String FLUTTERWAVE_PUBLIC_KEY = "FLWPUBK_TEST-c17a2f5bb0c370174574e97fee444360-X"; //Remember to change to your live public key!!!
    String FLUTTERWAVE_ENCRYPTION_KEY = "FLWSECK_TEST2ef9210c0001";//Remember to change to your live encryption key!!!
