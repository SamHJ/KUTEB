...
public class AppSession {
    ...
    public JsonArray getHomeSliders() {
        ...
        return new JsonParser().parse(Objects.requireNonNull(sharedPreferences.getString("home_slider", null)))
                .getAsJsonArray();
    }
    ...
    public JsonArray getCourses(){
        ...
        return new JsonParser().parse(Objects.requireNonNull(sharedPreferences.getString("courses", null)))
                .getAsJsonArray();
    }
    ...
    public JsonArray getVideos(){
        ...
        return new JsonParser().parse(Objects.requireNonNull(sharedPreferences.getString("videos", null)))
                .getAsJsonArray();
