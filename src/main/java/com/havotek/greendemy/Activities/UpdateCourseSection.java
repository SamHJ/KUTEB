...
public class UpdateCourseSection extends AppCompatActivity implements View.OnClickListener {

    private static final int REQUEST_STORAGE_PERMISSION = 513;
    private String lessonId,courseId,lessonTitle,lessonContent,lessonVideoUrl,lessonVideoFrom,lessonExternalLink,
    lessonAttachment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_course_section);
        ...
        lessonVideoUrl = getIntent().getStringExtra("video_url");
        lessonVideoFrom = getIntent().getStringExtra("video_from");
        lessonExternalLink = getIntent().getStringExtra("external_link");
        lessonAttachment = getIntent().getStringExtra("attachment");
        ...
        getSupportActionBar().setTitle("Update "+lessonTitle);
    ...
    private void initFields() {
        ...
        dialog = utilities.showLoadingDialog("Updating Lesson...","");
        ...
        if(lessonVideoFrom.equals("server")){
        ...
        }else if(lessonVideoFrom.equals("youtube")){
        ...
        input_title.setText(lessonTitle);
        input_content.setText(lessonContent);
        input_video_type.setText(lessonVideoFrom);
        input_video.setText(lessonVideoUrl);
        input_video_2.setText(lessonVideoUrl);
        input_external_link.setText(lessonExternalLink);
        input_attachment.setText(lessonAttachment);
            ...
            builderoptions_image.setItems(options_image, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(which == 0){
                        ...
                        input_video_type.setText("server");
                        input_video.setHint("Select Video");
                        ...
                        input_video.setHint("Enter YouTube video ID");
                        input_video_2.setText("");
                        input_video.setText("");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == video_gallery_Pic && resultCode == RESULT_OK &&
            ...
            videoFilePath = utilities.getAbsolutePath(videoUri);
        ...
        && data != null){
            ...
            attachmentFilePath = utilities.getAbsolutePath(attachmentUri);
    ...
    private void updateLesson() {
        ...
        communicator.updateLesson(lessonId,title,content,type,video,extlink,attachment,"updatelesson",
                isVideoEmpty,isAttachmentEmpty,videoUri, attachmentUri,UpdateCourseSection.this,
