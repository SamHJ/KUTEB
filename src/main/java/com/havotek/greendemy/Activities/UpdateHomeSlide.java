...
public class UpdateHomeSlide extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_home_slide);
    ...
    private void initFields() {
        ...
        dialog = utilities.showLoadingDialog("Updating Slide Item...","");;
        ...
        input_subtitle.setText(getIntent().getStringExtra("subtitle"));
        input_go_to_url.setText(getIntent().getStringExtra("gotourl"));

        final String sliderImg = getIntent().getStringExtra("image");

        try {

            Picasso.get().load(sliderImg).networkPolicy(NetworkPolicy.OFFLINE)
                    .placeholder(R.drawable.greendemy_logo)
                    .error(R.drawable.greendemy_logo).into(slide_img,
                    new Callback() {
                        @Override
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.btn_update_slide){
            ...
            if(commpressedImage == null){
                ...
                communicator.updateSlideItem("updateslideitem",title,subtitle,goToUrl,
                        getIntent().getStringExtra("id"), getIntent().getStringExtra("image"),
                        null,null, this,"yes");
    ...
    public void onErrorEvent(ErrorEvent errorEvent){
        ...
        Log.e("UpdateHomeSlide: ",errorEvent.getErrorMsg());
