...
public class Onboarding extends AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance(
                ...
                "GreenDemy allows you to enroll in different tasks related to the course you studied",
        ...
        addSlide(AppIntroFragment.newInstance(
                "Get Started",
                "It's time to learn with GreenDemy! Let's get started",
