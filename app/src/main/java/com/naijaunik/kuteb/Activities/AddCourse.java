...
public class AddCourse extends AppCompatActivity implements View.OnClickListener {
    ...
    private boolean isExecuted = false; //used to keep track of api responses
    ...
    private void initFields() {
        ...
        dialog = utilities.showLoadingDialog("Adding Course...","");
    ...
    private void updateCourse() {
        ...
        if(commpressedImage != null){
            ...
            communicator.updateCourse("",title, description,
                    noOfStudents,status,utilities.getAbsolutePath(resultUri),"no",
                    "uploadcourse",resultUri, AddCourse.this);

        }else{

            //no image was selected
            communicator.updateCourse("",title, description,
                    noOfStudents,status,"","yes",
                    "uploadcourse",null, AddCourse.this);
        }
        ...
        if(isExecuted) {
                ...
                if (serverResponse != null) {
                    ...
                    if (serverResponse.getResult().equals("success")) {
                        ...
                        input_no_of_students.setText("0");
                        course_image.setImageDrawable(getResources().getDrawable(R.drawable.course_placeholder));

                        utilities.dialogError(AddCourse.this, getString((R.string.upload_successful)));

                    } else {

                        //show login error dialog
                        utilities.dialogError(AddCourse.this, getString(R.string.error_occurred));
                    }
                } else {
    ...
    public void onErrorEvent(ErrorEvent errorEvent){
        ...
        Log.e("AddCourse: ",errorEvent.getErrorMsg());
