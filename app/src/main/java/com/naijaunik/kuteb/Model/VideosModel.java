...
public class VideosModel {
    ...
    private String id,course_id,course_title,section_title,
            content,video_url,video_from,external_link,attachment,attachment_extension;

    public VideosModel() {
    }

    public VideosModel(String id, String course_id, String course_title, String section_title,
