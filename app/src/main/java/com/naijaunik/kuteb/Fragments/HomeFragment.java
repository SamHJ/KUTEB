...
public class HomeFragment extends Fragment implements View.OnClickListener, CoursesAdapter.CoursesAdapterListener,
    ...
    private ProgressBar activity_loader;
    ...
    private void initFields(View homeFragmentView) {
        ...
        activity_loader = homeFragmentView.findViewById(R.id.activity_loader);
        ...
        try{
            showCourses(appSession.getCourses());

            showVideos(appSession.getVideos());
    ...
    private void showVideos(JsonArray videos) {
    ...
    private void showCourses(JsonArray courses) {
            ...
            if (serverResponse.getType().equals("homeslider")) {
                ...
                if (serverResponse.getResult().equals("success")) {
                    ...
                    if(appSession.getHomeSliders() == null){
                        ...
                        displaySlideItems(serverResponse.getData());

                    }else{

                        displaySlideItems(appSession.getHomeSliders());
                    }
                ...
                if(serverResponse.getResult().equals("success")){
                    ...
                    if(appSession.getCourses() == null){
                        ...
                        showCourses(serverResponse.getData());
                ...
                activity_loader.setVisibility(View.GONE);
                ...
                if(serverResponse.getResult().equals("success")){
                    ...
                    if(appSession.getVideos() == null){
                        ...
                        showVideos(serverResponse.getData());
    ...
    private void displaySlideItems(JsonArray data) {
